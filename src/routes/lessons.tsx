        ...
        {lessons.map((l, i) => (
          <li key={l.id}>
            <Link
              ...
              className={`${palette[i % palette.length]} flex items-center gap-4 rounded-3xl p-4 shadow-md ring-4 ring-white transition active:scale-95`}
            >
              <span className="flex h-14 w-14 shrink-0 items-center justify-center rounded-2xl bg-white text-3xl">
                {l.emoji}
              </span>

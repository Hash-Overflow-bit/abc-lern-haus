...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Spielerisch Deutsch lernen: Alphabet, Zahlen, Wörter & Uhrzeit." },
      { name: "theme-color", content: "#ff7a3d" },
      { property: "og:title", content: "Deutsch ABC für Kinder" },
      { property: "og:description", content: "Spielerisch Deutsch lernen: Alphabet, Zahlen, Wörter & Uhrzeit." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:site", content: "@Lovable" },
      { name: "twitter:title", content: "Deutsch ABC für Kinder" },
      { name: "twitter:description", content: "Spielerisch Deutsch lernen: Alphabet, Zahlen, Wörter & Uhrzeit." },

  ...
  head: () => ({
    meta: [
      ...
      { name: "twitter:description", content: "Spielerisch Deutsch lernen: Alphabet und Zahlen." },
      {
        property: "og:image",
        content:
          "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/512597d3-5b18-4099-9bc0-82e874a00df0/id-preview-1e1d7f40--e99a6c86-d1c0-43a5-a426-2e94ba48f892.lovable.app-1780329840895.png",
      },
      {
        name: "twitter:image",
        content:
    ...
    links: [
      ...
      { rel: "icon", href: "/icon.svg?v=3", type: "image/svg+xml" },
